...
import { Activity, Award, Crosshair, Heart, Shield, Sparkles, Zap } from 'lucide-react';

export function PokemonCard({ id, name, sprites, types, stats, abilities, base_experience }: IPokemon) {
	return (
